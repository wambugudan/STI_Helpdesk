        ...
        <div className="flex h-screen items-center justify-center gap-72 bg-gray-200">
          <div className="hidden items-center justify-around lg:flex">
            <div>
              ...
              <div className="mt-4 mb-2 block w-28 rounded-2xl py-2 font-bold text-indigo-800"></div>
            </div>
          </div>
          <div className="mx-4 w-full rounded-lg bg-white shadow md:mx-0 md:mt-0 md:w-7/12 xl:w-5/12 3xl:w-4/12">
            <div className="space-y-4 p-6 sm:py-10 sm:px-8 xl:space-y-6">
              ...
              <div className="items-center gap-2 pt-2 md:flex">
                <button
                  type="button"
                  className="mr-2 mb-2 inline-flex w-full items-center justify-center rounded-lg border border-gray-200 bg-white py-2.5 text-center text-sm font-medium text-gray-900 hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-100 md:w-1/2"
                >
                  <svg
